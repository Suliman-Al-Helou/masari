...
import { getConversation, sendMessage, markMessagesRead, type Message } from '@/lib/api';
import { supabase } from '@/lib/supabase';
import { getInitials } from '@/lib/constants/students';
...
export default function ChatPanel({ student, onClose, isMobile = false }: ChatPanelProps) {
  const { user } = useAuth();
